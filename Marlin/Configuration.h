...
#define STRING_CONFIG_H_AUTHOR "Gaurav - on " __DATE__ " at " __TIME__ // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "This is custom build for Ender-5 Pro 4.2.2"
